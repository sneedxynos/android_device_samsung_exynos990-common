...
ifeq ($(BOARD_USE_SEC_PRODUCT_FEATURE_AUDIO_COMMON),true)
LOCAL_CFLAGS += -DSEC_PRODUCT_FEATURE_AUDIO_COMMON
endif
...
ifeq ($(BOARD_USE_SEC_AUDIO_SUPPORT_PTT),true)
LOCAL_CFLAGS += -DSEC_AUDIO_SUPPORT_PTT
endif
